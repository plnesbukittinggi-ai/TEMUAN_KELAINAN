    ...
    <div className="pb-10">
      ...
      {data.length === 0 && !initialData ? (
        ...
        <div className="space-y-4">
          {data.map((item) => (
            <div key={item.id} className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm flex flex-col">
              ...
              <button 
                ...
                className="w-full bg-slate-900 text-white font-bold py-4 text-xs uppercase tracking-[0.2em]"
              >
